...
W = 1.5  # width of car
LF = 1.3  # distance from rear to vehicle front end
LB = 1.3  # distance from rear to vehicle back end
...
def plot_car(plt, x, y, yaw, color="-r", map_res=0.1, W=1.5, LF = 1.3, LB = 1.3, label=None, width=1, zorder=0):  # pragma: no cover
    VRX = [LF, LF, -LB, -LB, LF]
    VRY = [W / 2, -W / 2, -W / 2, W / 2, W / 2]
    car_color = color
    c, s = cos(yaw), sin(yaw)
